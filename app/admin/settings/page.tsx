...
import { Shield, CreditCard, CheckCircle2, ArrowRightLeft, Sparkles, RefreshCw } from "lucide-react";
...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-white mb-1">Pengaturan Sistem</h1>
        <p className="text-sm text-slate-400">
          Kelola konfigurasi payment gateway dan opsi sistem VendingLink
        </p>
      </div>

      {loading ? (
        <div className="py-20">
          <Spinner label="Memuat pengaturan sistem..." />
        </div>
      ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                  Metode pembayaran bawaan via Midtrans Snap (QRIS, VA Bank, GoPay, ShopeePay, dsb).
                </p>
              ...
              >
                ...
                <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                  Integrasi resmi DOKU (Jokul Checkout) untuk pembayaran instan via QRIS, E-Wallet, dan VA.
                </p>
                <div className="flex items-center justify-between text-xs pt-3 border-t border-surface-border/50">
                  <span className="text-slate-500">Kredensial .env</span>
