    ...
    <div className="max-w-5xl mx-auto animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-400 ml-14">
          Pilih produk yang ingin Anda beli dan bayar dengan metode favorit Anda
        </p>
      </div>
      ...
      <div className="mt-8 p-4 bg-surface-card border border-surface-border rounded-xl flex items-center gap-3">
        ...
        <p className="text-sm text-slate-400">
          Pembayaran melalui QRIS, transfer bank/VA, e-wallet, dan metode lainnya — Stok langsung diterima setelah pembayaran dikonfirmasi
        </p>
      </div>
    </div>
  );
