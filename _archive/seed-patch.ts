...
async function main() {
  // Enhanced Guard: Skip seed in production OR Vercel preview environments
  ...
  if (isProd || isVercel) {
    console.log("⚠️  Seed skipped in production/preview. Use change-password.js for password changes.");
    return;
  }
