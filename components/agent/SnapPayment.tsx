...
export default function SnapPayment({
  orderId,
  snapToken,
  amount,
  productName,
  ...
  // Snap.js is served from different hosts for sandbox vs production
  ...
  // Auto-open the Snap payment popup once as soon as script + token are ready,
  // so the flow feels the same as the old auto-shown QR code.
  useEffect(() => {
