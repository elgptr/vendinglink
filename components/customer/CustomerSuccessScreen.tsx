  ...
  return (
    <div className="max-w-md mx-auto animate-slide-up">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-slate-400">{isKode ? "Kode redeem Anda telah siap" : "Link redeem Anda telah siap"}</p>
      </div>
      ...
      <Card className="p-5 border-emerald-500/30 mb-4" glow>
        ...
        <div className="flex gap-3">
          ...
          {!isKode && (
            <a href={redeemUrl} target="_blank" rel="noopener noreferrer" id="customer-open-link-btn">
